...
WEBHOOK_URL = "https://agent-manager-428716175586.us-central1.run.app/agent/sap_success_factor_agent/webhook/invoke/3acef9c7-5830-43c8-8177-d4395388d9f4"
...
def get_applications(job_req_id: Optional[str] = None):
    url = f"{BASE_URL}/JobApplication?$select=applicationId,candidateId,firstName,lastName,jobReqId,appStatusSetItemId,startDate,contact_email"
