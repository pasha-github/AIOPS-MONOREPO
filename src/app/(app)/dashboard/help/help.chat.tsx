...
export const getSessionsUrl = (adkBaseUrl: string, appName: string, userId: string) =>
...
export const formatMilestoneDetails = (value: unknown) => {
...
export const summarizeStreamError = (errorText: string) => {
